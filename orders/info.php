                        ...
                        <div class="card shadow">
                            <div class="card-header border-0 pt-4">
                                <h4> 
                                    ...
                                    ข้อมูลใบสั่งผลิต Order ID : <?php echo $_GET['or_id'] ?>
                                </h4>
                            </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body px-5">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-xl-9">
                                                        <p class="btn btn-outline-primary p-1"> <?php echo $_GET['or_id'] ?> </p>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body px-5">
                                                <div class="row mb-3">
                                                    <p class="col-xl-3 text-muted">ชื่อผู้สั่งผลิต :</p>
                                                    <div class="col-xl-9">
                                                        <a href="../members/profile.php?id=1">วนัดดา แก้วตา</a>
                                                    </div>
                                                </div>
