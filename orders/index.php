        ...
        $.ajax({
            ...
            data.response.forEach(function (item, index){
                tableData.push([    
                    ...
                    `<a href="info.php?or_id=${item.or_id}" class="btn btn-outline-primary p-1 "> ${item.or_id} </button>`,
                    `<a href="../members/profile.php?id=${item.depo_idcus}">
                        ${item.cus_name}
                    </a>`,
                    item.total,
                    `<span class="text-muted small"> 1 ชั่วโมงที่ผ่านมา <br> 10 พ.ค. 64 · 16:56 น.</span>`,
                    `<span class="text-muted"> ${item.ps} </span>  `,
                    `<a href="info.php?or_id=${item.or_id}" class="btn btn-info">
        ...
        function initDataTables(tableData) {
            $('#logs').DataTable( {
                ...
                columns: [
                    ...
                    { title: "รหัสสั่งผลิต", className: "align-middle"},
                    { title: "ผู้สั่งผลิต/ลูกค้า", className: "align-middle"},
