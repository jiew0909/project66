                                        ...
                                        <div class="row">
                                            <div class="col-md-6 px-1 px-md-5">
                                                <div class="form-group">
                                                    <label for="sh_id">รหัสร้าน</label>
                                                    <input type="text" class="form-control" name="sh_id" id="sh_id" placeholder="รหัสร้าน" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="sh_name">ชื่อร้าน</label>
                                                    <input type="text" class="form-control" name="sh_name" id="sh_name" placeholder="ชื่อร้าน" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="sh_add">ที่อยู่</label>
                                                    <input type="text" class="form-control" name="sh_add" id="sh_add" placeholder="ที่อยู่" required>
                                                </div>
                                                <div class="form-group">
